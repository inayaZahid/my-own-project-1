...
math.position(displayWidth/2-250,displayHeight/2-150);
math.size(150,50)

math.mouseClicked(mathQuiz);
Gk=createButton('Gk')
Gk.position(displayWidth/2+250,displayHeight/2-150);
Gk.size(150,50)
Gk.mouseClicked(gkQuiz);
...
function mathQuiz(){
easy1=createButton('Easy')
easy1.position(displayWidth/2,displayHeight/2-100);
easy1.size(120,50);
medium1=createButton('Medium')
medium1.position(displayWidth/2,displayHeight/2-50);
medium1.size(120,50)
hard1=createButton('Hard');
hard1.position(displayWidth/2,displayHeight/2);
hard1.size(120,50);
